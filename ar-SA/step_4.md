...
انقر فوق علامة التبويب **التعليمات البرمجية** وتحقق من أن الصوت الصحيح في `تشغيل الصوت`كتلة  التي يتم تشغيلها عندما يصل الكائن إلى منصة {:class="block3sound} **النهاية**.
